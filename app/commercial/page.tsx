...
export const metadata: Metadata = {
  ...
  description: `Commercial dryer vent cleaning for apartments, HOAs, condos, and laundromats across Metro ${site.city}, TN. Volume pricing, flexible scheduling, and documented compliance reports. Call ${site.phone}.`,
